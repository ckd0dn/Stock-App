...
import 'package:practice/presentation/company_info/company_info_screen.dart';
import 'package:practice/presentation/company_info/company_info_view_model.dart';
import 'package:practice/presentation/company_listings/company_listings_action.dart';
...
class CompanyListingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    CompanyListingsState state = viewModel.state;
            ...
            child: RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                return Column(
                  children: [
                    ListTile(
                      title: Text(state.companies[index].name,style: const TextStyle(color:  Colors.white),),
                      onTap: () {
