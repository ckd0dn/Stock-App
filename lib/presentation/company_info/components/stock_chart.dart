...
class ChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < infos.length; i++) {
      final info = infos[i];
      var nextIndex = i + 1;
      if (i + i > infos.length - 1) nextIndex = infos.length - 1;
      ...
      final x2 = spacing + (i + i) * spacePerHour;
    ...
    final fillPaint = Paint()
      ...
      ..shader =
          ui.Gradient.linear(Offset.zero, Offset(0, size.height - spacing), [color.withOpacity(0.6), Colors.transparent ]);
